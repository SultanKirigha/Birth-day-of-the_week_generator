...
function submitFullNames(){
    ...
    if (gender === 'male'){
        alert("Hello you were born on a " + daysOfWeek[date.getDay()] + ',' + " your Ghana name is " + maleNames[date.getDay()]);
        document.getElementById('result').innerHTML = maleNames[date.getDay()]
    
    }
    else if (gender === 'female'){
        alert(" Hello you were born on " + daysOfWeek[date.getDay()] + ',' + " your Akan name is " + femaleNames[date.getDay()]);
